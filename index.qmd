...
::: {.card title="Worldwide Measles Cases in 2023" fill="false"}

This map shows measles cases per 100,000 people in 2023. Darker countries had higher population-adjusted measles rates. Countries are colored by measles cases per 100,000 people, making countries with different population sizes easier to compare.
```{r}
#| fig-height: 8
#| fig-width: 15
...
leaflet(world_measles, height = "1000px") |>
  addProviderTiles(providers$CartoDB.Positron,
                   options = providerTileOptions(noWrap = TRUE)) |>
  setView(lng = 30, lat = 0, zoom = 3) |>
